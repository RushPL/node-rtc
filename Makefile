...
test:
	cd build; export NODE_HEADERS="`make -pn  | grep 'INCS_Release' | sed 's/INCS_Release :=//'`"; cd ../test; g++ $$NODE_HEADERS -I ../3d_party/googletest/trunk/include/ main.unittest.cc ../3d_party/googletest/trunk/make/gtest-all.o -o testall && ./testall
